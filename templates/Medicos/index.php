 ...
 * @var iterable<\App\Model\Entity\Medico> $medicos
 */
?>
<div class="medicos index content">
    <?= $this->Html->link(__('New Medico'), ['action' => 'add'], ['class' => 'button new-medico-button']) ?>
    <h3><?= __('Medicos') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $medico->id], ['class' => 'action-link view']) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $medico->id], ['class' => 'action-link edit']) ?>
                        <?= $this->Form->postLink(
                            __('Delete'),
...
<style>
  ...
  .button.new-medico-button:hover,
  .button.new-medico-button:focus {
